...
MainWindow::MainWindow(QWidget* parent)
   ...
   , m_retryAttemptsSpin(nullptr)
   , m_retryBaseDelaySpin(nullptr)
   , m_retryMaxDelaySpin(nullptr)
   , m_retryBackoffSpin(nullptr)
   ...
   , m_monitorUsersLabel(nullptr)
   , m_monitorRequestsLabel(nullptr)
